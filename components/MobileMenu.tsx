...
const MobileMenu = () => {
  ...
  return (
    <>
      <HamburgerButton onClick={() => { openAnim?.restart(); unblurAnim?.restart() }} className="flex flex-row justify-center items-center lg:hidden" />
      <div id="mobile-menu" className="flex invisible flex-col items-start justify-start pb-0 lg:hidden bg-white gap-y-10 pt-10 fixed top-0 left-0 z-20 h-screen w-screen content-between">
