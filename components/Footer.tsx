...
export const Footer = () => {
  return (
    <footer className="bg-[#0c0a09] text-stone-400 leading-6 text-lg min-[0px]:flex min-[0px]:flex-col min-[0px]:items-center min-[0px]:justify-start  lg:grid lg:grid-cols-6 lg:grid-rows-1 lg:gap-y-4 gap-y-8 gap-x-8 pt-16 pb-8 px-2 lg:px-4 w-full h-full">
      <div className="grid md:col-span-6 grid-cols-2 lg:grid-cols-6 min-[0px]:gap-y-8 gap-x-4 px-4 2xl:w-3/4 2xl:mx-auto">
        <div className="min-[0px]:col-span-2 min-[0px]:w-full min-[0px]:flex flex-col items-start md:gap-y-6 gap-y-8 w-full md:mx-16 lg:w-9/12 lg:mx-auto">
          ...
          <div className="flex flex-row gap-x-6 items-center lg:items-start justify-start w-full [&_svg]:scale-[0.8]">
            <FBIcon color="#ec5f0e" />
        ...
        <div className="grid min-[0px]:grid-cols-1 min-[0px]:col-span-1 lg:col-span-2 flex-col min-[0px]:gap-y-12 space-y-8 pb-8 items-start justify-start md:grid md:ml-16 md:gap-x-8 md:grid-cols-2 lg:gap-x-8">
          <div className="flex flex-col items-start justify-start text-sm w-full min-[0px]:space-y-4 md:space-y-5">
            <h2 className="font-bold text-[#d6d3d1] md:text-lg">Services</h2>
            <ul className="list-none space-y-4 md:space-y-6 w-full">
        ...
        <div className="min-[0px]:col-span-1 flex flex-col gap-y-12 items-start justify-start md:grid md:gap-x-8 md:mr-20 md:grid-cols-2 lg:col-span-2">
          <div className="flex flex-col items-start justify-start text-sm w-full space-y-4 md:space-y-6">
        ...
        <div className="col-span-2 lg:col-span-6 flex flex-col justify-start items-start gap-y-8">
