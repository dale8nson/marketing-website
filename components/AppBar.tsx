...
const AppBar = () => {
  ...
  return (
    <header className="fixed top-0 w-full h-[4rem] bg-white flex flex-col min-[0px]:justify-between lg:justify-evenly items-center z-50 px-6 lg:px-24 shadow-[#dfdfde] drop-shadow-lg">
      <div className="flex flex-row md:w-10/12 min-[0px]:items-center min-[0px]:justify-between justify-between lg:justify-evenly min-[0px]:w-full h-full 2xl:w-3/5">
        <Logo />
      ...
      <Menu.Portal className="min-[0px]:hidden lg:block w-full h-full" ref={portalRef} />
    </header>
  )
