...
const Hero = () => {
  return (
    <section className="relative overflow-x-clip overflow-y-visible md:overflow-x-clip md:overflow-y-visible w-full h-full flex flex-row justify-center items-center">
      <GradientBg />
      <div className="relative z-20 grid grid-cols-1 lg:grid-cols-[45fr_35fr] gap-6 md:gap-4 md:px-8 pb-8 h-full w-full lg:w-full overflow-y-visible 2xl:w-3/5 2xl:px-0 2xl:grid-cols-[40fr_35fr]">
        <div className="flex flex-col justify-center items-start gap-6 h-full w-full pl-6 2xl:pl-0">
          <div className="flex flex-col items-start px-6 justify-start gap-y-8 w-full">
            ...
            <div className="flex flex-col justify-start items-start w-full gap-y-4">
              <h1 className="font-[manrope] md:mx-16 font-semibold text-4xl md:text-5xl text-center lg:text-left tracking-tighter text-[#1c1917]">Grow Your Business With Social Media Management & Content Marketing</h1>
            ...
            <div className="flex flex-col gap-y-2 justify-center md:!items-start items-center md:!justify-start w-full">
              <CTA className="text-white bg-[#ec5f0e] tracking-wider font-light h-10 py-3 text-sm md:mx-auto md:w-1/4 lg:ml-0">Sign up in 2 Minutes</CTA>
        ...
        <div className="relative flex flex-col justify-center items-start mx-0 w-full lg:overflow-y-visible overflow-x-clip 2xl:overflow-x-visible">
          <div className="relative grid min-[0px]:grid-cols-2 md:grid-cols-3 mt-8 gap-x-4 overflow-y-visible overflow-x-clip min-[0px]:w-full pl-1 pr-6 h-full lg:w-[108%] md:-translate-y-48 lg:translate-y-32 md:ml-16 md:scale-[0.8] md:gap-x-10">
            <div className="min-[0px]:hidden md:flex md:flex-col justify-center items-center lg:translate-y-24 lg:w-full">
              <SNSCard src="/example-social-media-post-for-pet-adoption.avif" likes="5.6K" uploads="769" />
            </div>
            <div className="flex flex-col gap-y-8 lg:translate-y-32 overflow-x-clip overflow-y-visible md:py-32 md:px-0 h-full">
            ...
            <div className="flex flex-col gap-y-8 min-[0px]:translate-y-32 md:-translate-y-32">
